...
public class BoletoJuno implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "venda_loja_site_id", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "venda_loja_site_fk"))
	private VendaSiteLoja vendaLojaSite;
	...
	public VendaSiteLoja getVendaLojaSite() {
		return vendaLojaSite;
	}

	public void setVendaLojaSite(VendaSiteLoja vendaLojaSite) {
		this.vendaLojaSite = vendaLojaSite;
	}
